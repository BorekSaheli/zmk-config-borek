...
ZMK_DISPLAY_WIDGET_LISTENER(widget_battery, struct status_state, update_top, get_state)
ZMK_SUBSCRIPTION(widget_battery, zmk_battery_state_changed);

ZMK_DISPLAY_WIDGET_LISTENER(widget_layer, struct status_state, update_bottom, get_state)
ZMK_SUBSCRIPTION(widget_layer, zmk_layer_state_changed);

ZMK_DISPLAY_WIDGET_LISTENER(widget_bt, struct status_state, full_update, get_state)
